          ...
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-4">
                ...
                >
                  <option value="vi" className="bg-[#3B9AB8] text-white">Tiếng Việt</option>
                  <option value="en" className="bg-[#3B9AB8] text-white">English</option>
                </select>
      ...
      <div className={`bg-white shadow-md transition-all duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            {/* Logo */}
            <div 
              className="flex items-center gap-3 cursor-pointer group border-t-2 border-[#3B9AB8] pt-2" 
              onClick={() => navigate("/")}
            >
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  <span className="text-base text-gray-700 flex items-center">
                    ...
                    Xin chào, <span className="text-[#3B9AB8] font-medium ml-1">{user.username}</span>
                  </span>
