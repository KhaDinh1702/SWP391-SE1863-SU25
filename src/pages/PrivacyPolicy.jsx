  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 py-16 text-gray-800 dark:text-gray-100">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl relative">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/50 rounded-lg">
