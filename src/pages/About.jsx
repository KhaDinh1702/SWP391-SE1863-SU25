...
export default function About() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white font-sans px-4 py-8 max-w-6xl mx-auto text-gray-800 md:px-8 md:py-12">
      {/* Back to Home Link */}
      ...
      <div className="text-center mb-16">
        ...
        <div className="text-xl md:text-2xl font-medium text-blue-700 mb-8 flex flex-wrap justify-center gap-4">
          <span className="inline-block px-4 py-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors duration-300">THÂN THIỆN</span>
          <span className="inline-block px-4 py-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors duration-300">TÂM TÌNH</span>
          <span className="inline-block px-4 py-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors duration-300">THẤU CẢM</span>
          <span className="inline-block px-4 py-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors duration-300">TRÁCH NHIỆM</span>
          <span className="inline-block px-4 py-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors duration-300">CHUYÊN NGHIỆP</span>
        </div>
      </div>
      ...
      {/* History Section */}
      <div className="mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-blue-800 mb-8 pb-2 border-b-2 border-blue-200">
          Lịch sử hình thành
        </h2>
      ...
      {/* Highlight Section */}
      <div className="text-center bg-gradient-to-r from-blue-800 to-blue-600 text-white rounded-2xl p-10 mb-16 shadow-xl transform hover:scale-[1.02] transition-transform duration-300">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            ...
            <h3 className="text-xl font-semibold text-blue-700 mb-4">Điều trị HIV/AIDS</h3>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            ...
            <h3 className="text-xl font-semibold text-blue-700 mb-4">Khám đa khoa</h3>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            ...
            <h3 className="text-xl font-semibold text-blue-700 mb-4">Hỗ trợ cộng đồng</h3>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <span className="text-blue-600 mr-2">•</span>
      ...
      <div className="bg-white rounded-2xl p-8 md:p-10 mb-16 shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="p-6 bg-blue-50 rounded-xl transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="p-6 bg-blue-50 rounded-xl transform hover:scale-105 transition-transform duration-300">
            <div className="text-4xl font-bold text-blue-600 mb-3">98%</div>
      ...
      <section className="bg-white rounded-2xl p-8 md:p-10 shadow-lg">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-xl font-medium text-blue-700 mb-6">Thông tin liên hệ</h3>
            <div className="space-y-6 text-lg">
              <p className="flex items-start group">
                <FaMapMarkerAlt className="w-5 h-5 text-blue-600 mr-4 mt-1 group-hover:text-blue-800 transition-colors duration-300" />
                <span className="text-gray-700">Trụ sở chính: 104 Trần Bình Trọng, Quận 5, TP.HCM</span>
              </p>
              <p className="flex items-center group">
                <FaPhone className="w-5 h-5 text-blue-600 mr-4 group-hover:text-blue-800 transition-colors duration-300" />
                <span className="text-gray-700">Hotline: <strong>0943 108 138</strong></span>
              </p>
              <p className="flex items-center group">
                <FaEnvelope className="w-5 h-5 text-blue-600 mr-4 group-hover:text-blue-800 transition-colors duration-300" />
                <a href="mailto:lienhe@3AEclinic.vn" className="text-blue-600 hover:text-blue-800 transition-colors duration-300">
                  lienhe@3AEclinic.vn
                </a>
              </p>
            </div>
          ...
          <div>
            <h3 className="text-xl font-medium text-blue-700 mb-6">Giờ làm việc</h3>
            <ul className="space-y-4 text-lg">
              <li className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                ...
                <span className="font-medium text-blue-700">7:30 - 19:00</span>
              </li>
              <li className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                <span className="text-gray-700">Thứ 7:</span>
                <span className="font-medium text-blue-700">7:30 - 17:00</span>
              </li>
              <li className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                <span className="text-gray-700">Chủ nhật:</span>
                <span className="font-medium text-blue-700">8:00 - 12:00</span>
              </li>
