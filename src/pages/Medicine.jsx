    ...
    <div className="font-sans bg-gradient-to-b from-[#f0f9fb] to-white min-h-screen">
      ...
      <div className="relative bg-[#3B9AB8] text-white py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h1 className="text-5xl font-bold mb-6 animate-fade-in leading-[1.4]">Nhà Thuốc 3AE</h1>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <section className="mb-16">
          <div className="flex items-center mb-8">
            <div className="bg-[#3B9AB8] p-3 rounded-xl mr-4">
              <MdHealthAndSafety className="text-3xl text-white" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-[#2a6d83]">Thuốc ARV Điều Trị HIV</h2>
              <p className="text-[#5a7d8a]">Các loại thuốc ARV được cấp phép và đảm bảo chất lượng</p>
            </div>
          </div>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <div>
                    ...
                    <div className="mb-4 space-y-3">
                      ...
                      <div className="flex justify-between py-2">
                        ...
                        <span className="font-bold text-[#3B9AB8]">{medicine.price}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-auto pt-4">
                    <button 
                      ...
                      className="w-full bg-[#3B9AB8] hover:bg-[#2d7e99] text-white px-4 py-3 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-[1.02]"
                    >
        ...
        <section>
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#2a6d83]">Thuốc Hỗ Trợ Khác</h2>
              <p className="text-[#5a7d8a]">Các loại thuốc hỗ trợ điều trị và dự phòng</p>
            </div>
          </div>
                  ...
                  <div>
                    ...
                    <div className="mb-4 space-y-3">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="bg-[#d1e9f3] text-[#2a6d83] px-3 py-1 rounded-full text-sm">
                          {medicine.category}
                        </span>
                      </div>
                      <div className="flex justify-between py-2">
        ...
        {/* Notice Section */}
        <div className="mt-16 bg-[#d1e9f3] border-l-4 border-[#3B9AB8] p-8 rounded-2xl shadow-lg">
          <h3 className="text-xl font-bold text-[#2a6d83] mb-4 flex items-center">
            <FiAlertCircle className="mr-2 text-2xl text-[#3B9AB8]" />
            Thông tin quan trọng
          </h3>
          <ul className="space-y-3 text-[#2a6d83]">
      ...
      <Modal
        title={
          <div className="flex items-center">
            <FaInfoCircle className="text-[#3B9AB8] mr-2 text-xl" />
            ...
            <div className="flex items-start gap-6 mb-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    <span className="font-medium text-gray-700">Giá:</span>
                    <span className="font-bold text-[#3B9AB8]">{selectedMedicine.price}</span>
                  </div>
